...
const Home: React.FC<{ 
  ...
  return (
    <div className="min-h-screen bg-[#0B0614] text-[#F5F3FA] relative overflow-x-hidden selection:bg-[#A855F7] selection:text-white">
      ...
      <nav className="fixed top-0 left-0 w-full z-[100] pt-0 lg:pt-1 pb-1 lg:pb-1 backdrop-blur-xl bg-black/20 border-b border-white/5 flex items-center">
        <div className="container mx-auto px-6 flex items-center justify-between">
          <img src={LOGO_MOR_GEYIK} alt="Logo" className="h-14 lg:h-20 w-auto object-contain hover:opacity-80 transition-all cursor-pointer -mb-1 lg:-mb-3 -mt-1 lg:-mt-2" onClick={() => navigate('/')} />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex space-x-6">
                <a href="https://instagram.com/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Instagram size={28} /></a>
                <a href="https://x.com/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><XLogo size={24} /></a>
                <a href="https://youtube.com/@acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Youtube size={28} /></a>
                <a href="https://linkedin.com/company/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Linkedin size={28} /></a>
              </div>
            </div>
          </div>
