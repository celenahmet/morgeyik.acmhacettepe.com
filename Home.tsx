      ...
      <footer className="pt-24 pb-12 px-6 border-t border-white/5 mt-20">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
            ...
            <div className="flex flex-col"><h4 className="text-white font-black text-lg mb-8 uppercase tracking-widest">{lang === 'TR' ? 'TAKİPTE KALIN' : 'STAY TUNED'}</h4><div className="flex space-x-6"><a href="https://instagram.com/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Instagram size={28} /></a><a href="https://x.com/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><XLogo size={24} /></a><a href="https://youtube.com/@acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Youtube size={28} /></a><a href="https://linkedin.com/company/acmhacettepe" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#A855F7] transition-colors"><Linkedin size={28} /></a></div></div>
          </div>
